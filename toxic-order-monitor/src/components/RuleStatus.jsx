    ...
    <section className="mb-5 rounded-2xl border border-slate-700/60 bg-slate-900/80 p-5 shadow-glow">
      ...
      <div className="mt-5 rounded-xl border border-cyan-400/20 bg-cyan-400/10 px-4 py-3">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h4 className="text-sm font-bold text-white">判断逻辑已移至使用指南</h4>
            <p className="mt-1 text-xs leading-5 text-slate-300">
              Candidate only，系统只做盘口 / 成交异常提醒，不执行下单、拦截、封禁或资金操作。短线评分、主力确认、交易所确认和 Discord gate 规则请在使用指南里查看。
            </p>
          </div>
          <a
            className="inline-flex items-center justify-center rounded-lg border border-cyan-300/40 px-3 py-2 text-sm font-semibold text-cyan-100 transition hover:border-cyan-200 hover:bg-cyan-400/10"
            href="/usage-guide"
          >
            打开使用指南
          </a>
